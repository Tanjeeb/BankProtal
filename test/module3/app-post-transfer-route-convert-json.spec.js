...
describe('Transfer post routes writeJSON', () => {
  it('should include writeJSON @app-post-transfer-routes-convert-json', () => {
    assert(typeof app === 'function', '`app` const has not been created in `app.js`.');
    const stack = routeStack('/transfer', 'post') || routeStack('/services/transfer', 'post');
    assert(typeof stack !== 'undefined', 'The transfer post routes may not exist yet.');
