...
describe('Transfer post routes from balance', () => {
  let stack;
  let handleSpy;
  ...
  it('should calculate `from` balance @app-post-transfer-routes-from-balance', () => {
    assert(typeof app === 'function', '`app` const has not been created in `app.js`.');
    assert(typeof handleSpy === 'function', 'The transfer post routes may not exist.');
