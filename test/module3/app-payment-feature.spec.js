...
describe('Payment Feature', () => {
  ...
  it('should contain payment feature @app-payment-feature', () => {
    ...
    assert(typeof getHandleSpy === 'function', 'The payment get routes may not exist.');
    const getReq = mockReq({});
    const getRes = mockRes();
    getHandleSpy(getReq, getRes);

    assert(getRes.render.called, 'The payment get routes may have not been created.');
    ...
    assert(typeof postHandleSpy === 'function', 'The payment post routes may not exist.');
    let accounts;
    try {
    ...
    assert(postRes.render.called, 'The payment post routes may have not been created.');
    assert(
